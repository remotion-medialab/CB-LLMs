...
#  Remove torch-related lines from requirements and install dependencies ===
...
# Install PyTorch for macOS (MPS backend)
python -m pip install "torch==2.2.2" "torchvision==0.17.2" "torchaudio==2.2.2"

# Fix NumPy compatibility (torch 2.2 requires NumPy < 2)
